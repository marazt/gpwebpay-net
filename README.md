...
- Fix of the missing MD parameter in PaymentResponse.

#### Version 1.4.2 (2020-10-01)

- Fix of the missing LANG parameter in url.
...
```
Install-Package GPWebpayNet.Sdk -Version 1.4.3
```
